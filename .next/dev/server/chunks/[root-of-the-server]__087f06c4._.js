...
"[project]/src/app/api/localization/translations/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        let language;
        if (languageCode) {
            language = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].language.findFirst({
                where: {
                    projectId,
                    code: languageCode,
                    isEnabled: true
        ...
        const translations = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].translation.findMany({
            where: {
                projectId,
...
async function POST(request) {
    try {
        ...
        const localizationKey = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].localizationKey.findUnique({
            where: {
                id: keyId
            },
            include: {
        ...
        const language = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].language.findUnique({
            where: {
                id: languageId
            }
        });
        ...
        const existingTranslation = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].translation.findUnique({
            where: {
                keyId_languageId: {
                    keyId,
                    languageId
        ...
        const translation = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].translation.upsert({
            where: {
        ...
        if (existingTranslation && existingTranslation.value !== translation.value) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].translationHistory.create({
                data: {
        ...
        if (value && body.sourceLanguageId && body.sourceText) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].translationMemory.upsert({
                where: {
...
async function DELETE(request) {
    try {
        ...
        const translation = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].translation.findUnique({
            where: {
                id: translationId
            },
            include: {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].translation.delete({
            where: {
                id: translationId
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__087f06c4._.js.map