...
async function POST(request) {
    try {
        ...
        const { projectId, title, description, endpoint, method, isEnabled, monitorStandardErrors, standardErrorCodes, customStatusCodes, bodyErrorField, bodyErrorValues, headerErrorField, headerErrorValues, notifyEmail, notifyPush, notifySms, notifyWebhook, cooldownMinutes } = body;
        if (!projectId || !title) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$8_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$1_react$40$19$2e$2$2e$1_$5f$react$40$19$2e$2$2e$1$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const alert = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].apiAlert.create({
            data: {
                projectId,
                title,
...
async function PUT(request) {
    try {
        ...
        const existingAlert = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].apiAlert.findUnique({
            where: {
                id
            },
            include: {
        ...
        const alert = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].apiAlert.update({
            where: {
                id
            },
            data: updateData
...
async function DELETE(request) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].apiAlert.delete({
            where: {
                id: alertId
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__211e66e1._.js.map