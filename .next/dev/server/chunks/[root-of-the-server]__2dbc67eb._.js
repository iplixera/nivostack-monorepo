...
async function GET(request) {
    try {
        ...
        let settings = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].notificationSettings.findUnique({
            where: {
                projectId
            }
        });
        if (!settings) {
            settings = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].notificationSettings.create({
                data: {
                    projectId
                }
            });
...
async function PUT(request) {
    try {
        ...
        const settings = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].notificationSettings.upsert({
            where: {
                projectId
            },
            update: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2dbc67eb._.js.map