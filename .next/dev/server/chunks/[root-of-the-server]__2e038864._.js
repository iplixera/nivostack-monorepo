...
async function GET(request) {
    try {
        ...
        const totalCostResult = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].apiTrace.aggregate({
            where: whereClause,
            _sum: {
                cost: true
            },
        ...
        // Cost by endpoint
        const tracesByEndpoint = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].apiTrace.groupBy({
            by: [
                'url',
                'method'
            ],
        ...
        // Cost by device
        const deviceCosts = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].apiTrace.groupBy({
            by: [
                'deviceId'
            ],
            where: {
        ...
        const deviceIds = deviceCosts.map((d)=>d.deviceId).filter(Boolean);
        ...
        const sessionCosts = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].session.findMany({
            where: {
                projectId,
                ...deviceId ? {
                    deviceId
        ...
        const sessionsWithCost = await Promise.all(sessionCosts.map(async (session)=>{
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$8_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$1_react$40$19$2e$2$2e$1_$5f$react$40$19$2e$2$2e$1$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            summary: {
                ...
                uniqueEndpointsCost,
                avgCostPerRequest: totalCostResult._count > 0 ? (totalCostResult._sum.cost || 0) / totalCostResult._count : 0
            },
            endpointCosts,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2e038864._.js.map