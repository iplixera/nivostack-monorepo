...
"[project]/src/app/api/config-categories/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const categories = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].configCategory.findMany({
            where: {
...
async function POST(request) {
    try {
        ...
        const maxOrder = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].configCategory.aggregate({
            where: {
                projectId
            },
            _max: {
        ...
        const category = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].configCategory.create({
            data: {
                projectId,
                name,
                label: label || null,
...
async function PUT(request) {
    try {
        ...
        const existingCategory = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].configCategory.findUnique({
            where: {
                id
            },
            include: {
        ...
        const category = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].configCategory.update({
            where: {
                id
            },
            data: {
...
async function DELETE(request) {
    try {
        ...
        // Verify category ownership via project
        const category = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].configCategory.findUnique({
            where: {
                id: categoryId
            },
            include: {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].configCategory.delete({
            where: {
                id: categoryId
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5cef1677._.js.map