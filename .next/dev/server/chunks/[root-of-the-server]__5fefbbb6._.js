...
"[project]/src/app/api/subscription/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        let subscription = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$subscription$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSubscription"])(userId);
        // If no subscription exists, create a free one (shouldn't happen, but safety check)
        if (!subscription) {
            const { createSubscription } = await __turbopack_context__.A("[project]/src/lib/subscription.ts [app-route] (ecmascript, async loader)");
            try {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5fefbbb6._.js.map