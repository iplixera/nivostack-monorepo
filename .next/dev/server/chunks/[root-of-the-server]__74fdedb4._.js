...
"[project]/src/app/api/crashes/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const validation = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$subscription$2d$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateFeature"])(project.userId, 'crashReporting');
        if (!validation.valid) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$8_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$1_react$40$19$2e$2$2e$1_$5f$react$40$19$2e$2$2e$1$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const throttling = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$throttling$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkThrottling"])(project.userId, 'crashes');
        ...
        const crash = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].crash.create({
            data: {
                projectId: project.id,
                deviceId: device?.id,
                message,
...
async function GET(request) {
    try {
        ...
        if (deviceId) {
            const device = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].device.findFirst({
                where: {
                    projectId,
                    deviceId,
                    status: 'active'
        ...
        if (platform) {
            const devicesWithPlatform = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].device.findMany({
                where: {
                    projectId,
                    platform,
                    status: 'active'
            ...
            if (devicesWithPlatform.length > 0) {
                where.deviceId = {
                    in: devicesWithPlatform.map((d)=>d.id)
                };
            } else {
        ...
        const [crashes, total, allDevices] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].crash.findMany({
                where,
                include: {
                    device: {
                        select: {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].device.findMany({
                where: {
                    projectId,
                    status: 'active'
                },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__74fdedb4._.js.map