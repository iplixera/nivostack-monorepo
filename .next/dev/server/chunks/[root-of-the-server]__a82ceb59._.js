...
"[project]/src/app/api/traces/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function isTrackingEnabled(projectId, deviceId) {
    ...
    const [featureFlags, sdkSettings, device] = await Promise.all([
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].featureFlags.findUnique({
            where: {
                projectId
            },
            select: {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].sdkSettings.findUnique({
            where: {
                projectId
            },
            select: {
        ...
        deviceId ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].device.findFirst({
            where: {
                projectId,
                deviceId
            },
...
async function checkAlertsForTrace(projectId, trace) {
    try {
        ...
        const alerts = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].apiAlert.findMany({
            where: {
                projectId,
                isEnabled: true
            }
        ...
        for (const alert of alerts){
            ...
            if (isError) {
                ...
                const existingError = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].monitoredError.findFirst({
                    where: {
                        alertId: alert.id,
                        projectId,
                ...
                if (existingError) {
                    ...
                    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].monitoredError.update({
                        where: {
                            id: existingError.id
                        },
                        data: {
                    ...
                    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].monitoredError.create({
                        data: {
                            alertId: alert.id,
                            projectId,
                            errorType,
...
async function calculateTraceCost(projectId, url, method) {
    try {
        ...
        let config = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].apiConfig.findFirst({
            where: {
                projectId,
                endpoint: endpointPath,
                method: method,
        ...
        if (!config) {
            config = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].apiConfig.findFirst({
                where: {
                    projectId,
                    endpoint: endpointPath,
                    method: null,
...
async function POST(request) {
    try {
        const project = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateApiKey"])(request);
        if (!project) {
        ...
        const validation = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$subscription$2d$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateFeature"])(project.userId, 'apiTracking');
        if (!validation.valid) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$8_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$1_react$40$19$2e$2$2e$1_$5f$react$40$19$2e$2$2e$1$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const requestsThrottling = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$throttling$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkThrottling"])(project.userId, 'apiRequests');
        ...
        const endpointsThrottling = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$throttling$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkThrottling"])(project.userId, 'apiEndpoints');
        if (endpointsThrottling.throttled || endpointsThrottling.usage && endpointsThrottling.usage.limit !== null && endpointsThrottling.usage.used >= endpointsThrottling.usage.limit) {
            ...
            const existingTrace = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].apiTrace.findFirst({
                where: {
        ...
        let device = null;
        if (deviceId) {
            device = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].device.findFirst({
                where: {
                    projectId: project.id,
                    deviceId,
                    status: 'active'
        ...
        let session = null;
        if (sessionToken) {
            session = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].session.findUnique({
                where: {
                    sessionToken
                }
            });
        ...
        const trace = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].apiTrace.create({
            data: {
                projectId: project.id,
                deviceId: device?.id,
...
async function GET(request) {
    try {
        ...
        const screenNames = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].apiTrace.findMany({
            where: {
                projectId
            },
            select: {
        ...
        const devices = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].device.findMany({
            where: {
                projectId
            },
            select: {
        ...
        const [traces, total] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].apiTrace.findMany({
                where,
                include: {
                    device: {
                        select: {
...
async function DELETE(request) {
    try {
        ...
        if (traceId) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].apiTrace.delete({
                where: {
                    id: traceId,
                    projectId
                }
        ...
        if (deviceId) where.deviceId = deviceId;
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].apiTrace.deleteMany({
            where
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$8_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$1_react$40$19$2e$2$2e$1_$5f$react$40$19$2e$2$2e$1$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a82ceb59._.js.map