...
"[project]/src/app/api/localization/providers/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const providers = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].translationProvider.findMany({
            where: {
                projectId
            },
            select: {
...
async function POST(request) {
    try {
        ...
        const { projectId, provider, apiKey, apiSecret, isEnabled, autoTranslate, defaultSourceLanguageId } = await request.json();
        ...
        const translationProvider = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].translationProvider.upsert({
            where: {
                projectId_provider: {
                    projectId,
                    provider
            ...
            update: {
                ...
                ...defaultSourceLanguageId !== undefined && {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e02a863d._.js.map