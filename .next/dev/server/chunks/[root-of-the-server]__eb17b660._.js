...
async function GET(request) {
    try {
        ...
        if (errorId) {
            const error = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].monitoredError.findUnique({
                where: {
                    id: errorId
                },
                include: {
        ...
        const [errors, total] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].monitoredError.findMany({
                where,
                include: {
                    alert: {
                        select: {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].monitoredError.count({
                where
            })
        ]);
        // Get summary stats
        const stats = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].monitoredError.groupBy({
            by: [
                'isResolved'
            ],
            where: {
...
async function PUT(request) {
    try {
        ...
        const existingError = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].monitoredError.findUnique({
            where: {
                id
            },
            include: {
        ...
        const error = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].monitoredError.update({
            where: {
                id
            },
            data: updateData,
...
async function DELETE(request) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].monitoredError.delete({
            where: {
                id: errorId
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eb17b660._.js.map