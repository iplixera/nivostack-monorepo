module.exports = [
"[project]/src/app/(dashboard)/admin/configurations/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminConfigurationsPage() {
    ...
    const loadConfigurations = async ()=>{
        try {
            setLoading(true);
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].admin.getConfigurations(token, activeCategory);
    ...
    const handleSave = async (key, value, encrypted)=>{
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].admin.saveConfiguration({
    ...
    const handleTest = async (key, testType)=>{
        try {
            ...
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].admin.testConfiguration(activeCategory, key, testType, testData, token);
            setTestResult({
                key,
                ...result.testResult
            });
...
//# sourceMappingURL=src_app_%28dashboard%29_admin_configurations_page_tsx_60055236._.js.map