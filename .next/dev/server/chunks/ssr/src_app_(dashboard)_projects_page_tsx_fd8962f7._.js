...
function ProjectsPage() {
    ...
    const fetchProjects = async ()=>{
        if (!token) return;
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].projects.list(token);
    ...
    const fetchUsageStats = async ()=>{
        if (!token) return;
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].subscription.getUsage(token);
            if (data && data.usage) {
                setUsageStats({
    ...
    const handleCreateProject = async (e)=>{
        ...
        setCreateError('');
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].projects.create(newProjectName, token);
            setNewProjectName('');
...
//# sourceMappingURL=src_app_%28dashboard%29_projects_page_tsx_fd8962f7._.js.map