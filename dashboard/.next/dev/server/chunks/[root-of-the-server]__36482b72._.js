...
"[project]/dashboard/src/lib/subscription-history.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "createHistoryRecord",
    ()=>createHistoryRecord,
    "getHistoryBySubscriptionId",
    ()=>getHistoryBySubscriptionId,
    "getHistoryByUserId",
    ()=>getHistoryByUserId,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$dashboard$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/dashboard/src/lib/prisma.ts [app-route] (ecmascript)");
;
async function createHistoryRecord(subscriptionId, data) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$dashboard$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].subscriptionHistory.create({
        data: {
            subscriptionId,
            userId: data.userId,
            planId: data.planId,
...
async function getHistoryByUserId(userId) {
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$dashboard$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].subscriptionHistory.findMany({
            where: {
                userId
            },
            orderBy: {
        ...
        if (error?.message?.includes('subscriptionHistory') || error?.code === 'P2001' || error?.name === 'PrismaClientKnownRequestError' || error?.message?.includes('Unknown model')) {
...
async function getHistoryBySubscriptionId(subscriptionId) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$dashboard$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].subscriptionHistory.findMany({
        where: {
            subscriptionId
        },
...
async function getSubscriptionCount(userId) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$dashboard$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].subscriptionHistory.count({
        where: {
            userId,
            status: 'completed'
        }
...
"[project]/dashboard/src/app/api/subscription/history/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$dashboard$2f$src$2f$lib$2f$subscription$2d$history$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/dashboard/src/lib/subscription-history.ts [app-route] (ecmascript)");
;
;
;
async function GET(request) {
    try {
        ...
        const history = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$dashboard$2f$src$2f$lib$2f$subscription$2d$history$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getHistoryByUserId"])(payload.userId);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$8_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$1_react$40$19$2e$2$2e$1_$5f$react$40$19$2e$2$2e$1$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            history
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__36482b72._.js.map