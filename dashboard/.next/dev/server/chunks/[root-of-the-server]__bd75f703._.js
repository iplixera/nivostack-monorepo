...
"[project]/dashboard/src/app/api/health/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (!migrationChecked && !migrationRunning && dbUrl) {
            ...
            try {
                ...
                const schemaPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(cwd, '..', 'prisma', 'schema.prisma');
                ...
                const { stdout, stderr } = await execAsync(`npx --yes prisma@5.22.0 db push --schema="${schemaPath}" --accept-data-loss --skip-generate`, {
                    cwd: cwd,
                    timeout: 60000,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bd75f703._.js.map