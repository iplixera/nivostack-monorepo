...
"[project]/dashboard/src/app/api/invitations/[token]/accept/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request, { params }) {
    try {
        ...
        // Get invitation
        const invitation = await __TURBOPACK__imported__module__$5b$project$5d2f$dashboard$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].projectInvitation.findUnique({
            where: {
                token
            },
            include: {
        ...
        const existingMember = await __TURBOPACK__imported__module__$5b$project$5d2f$dashboard$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].projectMember.findUnique({
            where: {
                projectId_userId: {
        ...
        // Check seat limits
        const seatCheck = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$dashboard$2f$src$2f$lib$2f$team$2d$access$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkSeatLimit"])(invitation.projectId);
        ...
        const notifications = await __TURBOPACK__imported__module__$5b$project$5d2f$dashboard$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].userNotification.findMany({
            where: {
                userId: user.id,
                type: 'invitation'
            }
        ...
        for (const notif of notifications){
            if (notif.data && typeof notif.data === 'object' && 'invitationId' in notif.data) {
                if (notif.data.invitationId === invitation.id) {
                    await __TURBOPACK__imported__module__$5b$project$5d2f$dashboard$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].userNotification.delete({
                        where: {
                            id: notif.id
                        }
                    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__be82cacd._.js.map