...
"[project]/dashboard/src/lib/forecasting.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function calculateChurnRisk() {
    ...
    for (const sub of subscriptions){
        try {
            ...
            const paymentIssues = (sub.paymentRetryCount || 0) > 0;
            // High risk: 100%+ usage OR in grace period OR multiple payment retries
            if (maxUsage >= 100 || inGracePeriod || (sub.paymentRetryCount || 0) >= 3) {
                highRisk++;
...
async function calculateRevenueForecast() {
    ...
    const { getSubscriptionAnalytics } = await __turbopack_context__.A("[project]/dashboard/src/lib/subscription-analytics.ts [app-route] (ecmascript, async loader)");
    ...
    const highRiskMRR = subscriptions.filter((sub)=>{
        // Simplified - would need to check actual risk
        return (sub.paymentRetryCount || 0) >= 3 || sub.gracePeriodEnd && sub.gracePeriodEnd > new Date();
...
async function calculateConversionForecast() {
    const { getSubscriptionAnalytics } = await __turbopack_context__.A("[project]/dashboard/src/lib/subscription-analytics.ts [app-route] (ecmascript, async loader)");
    const analytics = await getSubscriptionAnalytics();
    ...
    const estimatedRevenue = opportunities.slice(0, estimatedConversions).reduce((sum, opp)=>{
        const currentPrice = planPrices[opp.currentPlan] || 0;
        const recommendedPrice = planPrices[opp.recommendedPlan] || 0;
...
"[project]/dashboard/src/app/api/admin/forecast/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$dashboard$2f$src$2f$lib$2f$forecasting$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/dashboard/src/lib/forecasting.ts [app-route] (ecmascript)");
;
;
;
async function GET(request) {
    try {
        ...
        const forecast = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$dashboard$2f$src$2f$lib$2f$forecasting$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getForecastMetrics"])();
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$8_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$1_react$40$19$2e$2$2e$1_$5f$react$40$19$2e$2$2e$1$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            forecast
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fec3fa44._.js.map