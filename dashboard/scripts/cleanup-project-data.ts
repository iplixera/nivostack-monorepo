 ...
 *
 * This script can be run directly on the server or locally with proper DB connection
 *
 * Usage:
 *   cd dashboard && npx tsx scripts/cleanup-project-data.ts <projectId>
 *
 * Example:
 *   cd dashboard && npx tsx scripts/cleanup-project-data.ts cmkiixzic00039krtzw3ynm87
 */
...
if (!projectId) {
  ...
  console.log(`Usage: npx tsx scripts/cleanup-project-data.ts <projectId>\n`)
  console.log(`Example: npx tsx scripts/cleanup-project-data.ts cmkiixzic00039krtzw3ynm87\n`)
  process.exit(1)
}
