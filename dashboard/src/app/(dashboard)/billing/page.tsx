  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 dark:text-gray-400">Manage your payment method and billing information</p>
      </div>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-lg p-6 border border-gray-200 dark:border-gray-800">
        ...
        <button
          disabled
          className="px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-400 rounded cursor-not-allowed text-sm"
        >
      ...
      <div className="bg-white dark:bg-gray-900 rounded-lg p-6 border border-gray-200 dark:border-gray-800">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Billing Email</h2>
