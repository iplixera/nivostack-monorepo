  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 dark:text-gray-400">View and download your invoice history</p>
      </div>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-lg p-6 border border-gray-200 dark:border-gray-800">
        <div className="text-center py-12">
          ...
          <h3 className="mt-4 text-lg font-semibold text-gray-900 dark:text-white">No Invoices</h3>
