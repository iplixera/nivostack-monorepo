...
await DevBridge.init(
  apiKey: 'your-api-key',
  endpoint: 'https://devbridge.vercel.app',
);
...
// SDK handles everything!`}</pre>
            ...
            <div>
              ...
              <pre className="p-4 bg-gray-950 rounded text-sm text-gray-300 overflow-x-auto">{`// Copy DevBridge.swift or DevBridge.kt
...
// Track API calls
DevBridge.trace(request, response)`}</pre>
            </div>
          </div>
        </div>
      ...
      <footer className="border-t border-gray-800 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              <h3 className="text-white font-semibold mb-4">DevBridge</h3>
